...
import 'src/_provider_app/main_page/provider_main_page.dart';
import 'src/_client_app/main_page/client_main_page.dart';
import 'src/onboarding/onboarding_page.dart';
import 'src/select_role/app_role.dart';
import 'src/select_role/select_app_role_page.dart';
    ...
    return BlocBuilder<AppAuthenticationBloc, AppAuthenticationState>(
      builder: (context, state) {
        ...
        if (state is AuthUninitialized) {
          ...
          root = const SelectAppRolePage();
        } else {
          if (state.appRole == AppRoleEnum.client) {
            root = const ClientMainPage();
          } else {
            root = const ProviderMainPage();
          }
        }
