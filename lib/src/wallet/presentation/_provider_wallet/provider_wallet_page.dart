...
import 'provider_wallet_cubit.dart';
...
class ProviderWalletPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => injector<ProviderWalletCubit>()
        ..getBalance()
        ..getWalletHistory(),
      child: const _ProviderWalletPageBody(),
    );
  }
}

class _ProviderWalletPageBody extends StatefulWidget {
  const _ProviderWalletPageBody();

  @override
  State<_ProviderWalletPageBody> createState() => _ProviderWalletPageBodyState();
}

class _ProviderWalletPageBodyState extends State<_ProviderWalletPageBody> {
  final ScrollController _scrollController = ScrollController();
  late final ProviderWalletCubit _cubit;

  @override
  void initState() {
    super.initState();
    _cubit = context.read<ProviderWalletCubit>();
        ...
        child: LiquidPullToRefresh(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              BlocBuilder<ProviderWalletCubit, ProviderWalletState>(
                ...
                builder: (context, globalState) {
                  ...
                  if (state.isLoading) {
                    ...
                    return SliverFillRemaining(
                      child: AppFailWidget(
                        onRetry: () {
                          context.read<ProviderWalletCubit>().getWalletHistory();
                        },
                      ),
                    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: BlocSelector<ProviderWalletCubit, ProviderWalletState, Async<BalanceEntity>>(
              selector: (state) {
...
class _WithDrawButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ProviderWalletCubit, ProviderWalletState>(
      builder: (ctx, state) {
...
class _WithdrawBalanceBottomSheet extends StatefulWidget {
  final ProviderWalletCubit providerWalletCubit;
  const _WithdrawBalanceBottomSheet({required this.providerWalletCubit});

  static Future<bool?> show({required BuildContext context, required ProviderWalletCubit providerWalletCubit}) async =>
...
class _WithdrawBalanceBottomSheetState extends State<_WithdrawBalanceBottomSheet> {
                ...
                children: [
                  Expanded(
                    child: BlocProvider.value(
                      value: widget.providerWalletCubit,
                      child: BlocConsumer<ProviderWalletCubit, ProviderWalletState>(
  ...
  void onWithdrawl(BuildContext context, ProviderWalletCubit providerWalletCubit) async {
