...
import '../home/presentation/client_home_page.dart';
import '../more/presentation/more_page/client_more_page.dart';
      ...
      body: PopScope(
        ...
        child: IndexedStack(
          ...
          children: [
            ...
            OffStage(isActive: _currentTabEnum == ClientMainPageTabsEnum.more, child: const ClientMorePage()),
          ],
        ),
      ),
