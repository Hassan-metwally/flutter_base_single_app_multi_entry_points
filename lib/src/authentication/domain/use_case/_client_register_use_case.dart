...
@Injectable()
class ClientRegisterUseCase extends IUseCase<void, ClientRegisterParams> {
  final AuthenticationRepository _repository;

  ClientRegisterUseCase(this._repository);

  @override
  Future<Either<Failure, void>> call(ClientRegisterParams params) async {
    return await _repository.clientRegister(params);
  }
}

class ClientRegisterParams extends Equatable {
