...
import 'provider_more_cubit.dart';

part 'widgets/grid_cards.dart';
...
class ProviderMorePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => injector<ProviderMoreCubit>(),
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            AnimatedSlideWithOpacityWidget(
              ...
              child: _GroupTiles(
                title: appLocalizer.staticPages,
                children: [
                  _Tile(
                    icon: "",
            ...
            AnimatedSlideWithOpacityWidget(
              ...
              child: _GroupTiles(
                ...
                textStyle: TextStyles.regular12.copyWith(color: AppColors.black400),
                children: [
                  _Tile(
                    icon: "",
