...
abstract class AppTheme {
  ...
  Color get black => black500;
  final Color black50 = const Color(0xffF2F2F2);
  final Color black100 = const Color(0xffE6E6E6);
  final Color black200 = const Color(0xffCCCCCC);
  final Color black300 = const Color(0xffB3B3B3);
  final Color black400 = const Color(0xff999999);
  final Color black500 = const Color(0xff000000);
  final Color black600 = const Color(0xff666666);
  final Color black700 = const Color(0xff4D4D4D);
  final Color black800 = const Color(0xff333333);
  final Color black900 = const Color(0xff1A1A1A);
  ...
  final Color red400 = const Color(0xFFF33333);
  ...
  final Color warning50 = const Color(0xFFFFF4E5);
  final Color warning100 = const Color(0xFFFFE8CC);
  final Color warning200 = const Color(0xFFFFD199);
  final Color warning300 = const Color(0xFFFFBA66);
  final Color warning400 = const Color(0xFFFFA333);
  final Color warning500 = const Color(0xFFFB8A00);
  final Color warning600 = const Color(0xFFCC7000);
  final Color warning700 = const Color(0xFF995400);
  final Color warning800 = const Color(0xFF663800);
  final Color warning900 = const Color(0xFF331C00);

  final Color success50 = const Color(0xFFE8FDF6);
  final Color success100 = const Color(0xFFD0FBEE);
  final Color success200 = const Color(0xFFA2F6DD);
  final Color success300 = const Color(0xFF73F2CC);
  final Color success400 = const Color(0xFF44EEBB);
  final Color success500 = const Color(0xFF0D8D67);
  final Color success600 = const Color(0xFF11BB88);
  final Color success700 = const Color(0xFF0D8C66);
  final Color success800 = const Color(0xFF095D44);
  final Color success900 = const Color(0xFF042F22);
