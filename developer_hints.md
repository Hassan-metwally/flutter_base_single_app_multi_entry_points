...
## App Bundles :
                        ## IOS ##                 |          ## Android ##
                ------------------------------------------------------------------
                    com.moltaqa.azhimny           |        com.moltaqa.azhimny
...
## Flutter Fire Flavour Apps Configs:
    ...
    --android-package-name=com.moltaqa.azhimny.client \
    --ios-bundle-id=com.moltaqa.azhimny.client

    flutterfire config \
    --project=azhamani-d5ed8 \
    --out=lib/src/_provider_app/provider_firebase_options.dart \
    --android-package-name=com.moltaqa.azhimny.provider \
    --ios-bundle-id=com.moltaqa.azhimny.provider
